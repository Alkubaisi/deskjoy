...
space7 = Space.create! user: harry, company_name: "Startup Harry", address: "34 old street", industry: "Writer", company_info: "StartUp Harry is a national campaign by entrepreneurs for entrepreneurs, harnessing the expertise and passion of Britain’s leading businesspeople to unleash entrepreneurship across the UK.", photos: [File.open("app/assets/images/advert.jpg", 'r'), File.open("app/assets/images/advert2.jpg", 'r')], wifi: true, lockers: true, security: true, event_space: true
space8 = Space.create! user: ralph, company_name: "Snotties", address: "70 old street", industry: "Graphic Design", company_info: "Founded in 2011 by a former gallerist who got tired of sifting through cumbersome binders, Snotties was created to give art galleries a new way to manage their inventory.", photos: [File.open("app/assets/images/art.jpg", 'r'), File.open("app/assets/images/art2.jpg", 'r')], wifi: true, lockers: true, security: true, event_space: true
