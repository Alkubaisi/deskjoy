...
space12 = Space.create! user: kit, company_name: "Gotham Creative", address: "Covent Garden WC1", industry: "Graphic Design", company_info: "We are a digital creative agency, built from a collective of designers, developers and strategists. We help our clients by defining their position, expanding their brands and creating customer-centric websites and mobile applications. The Gotham Creative offices are based in Covent Garden and we have a selection of both fixed and hot desks for rent. Our friendly team are more than happy to lend you a hand or advise on anything creative. We have a cafe and an office dog!", photos: [File.open("app/assets/images/advert.jpg", 'r'), File.open("app/assets/images/advert2.jpg", 'r')], wifi: true, lockers: true, security: true, event_space: true, kitchen: true, showers: true, cafe_restaurant: true
...
table = Table.create! space: space12, desk_type: "private hot desk", price: 13
table = Table.create! space: space12, desk_type: "fixed desk with city view", price: 20
